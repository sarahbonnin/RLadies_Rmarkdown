...
* Includes R code that can be **shown** and/or **executed**
...
````r
Here is a [link]("https://rmarkdown.rstudio.com/") to {rmarkdown} page on [R Studio](https://rstudio.com/) website.
````

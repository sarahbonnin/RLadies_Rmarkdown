...
MarkDown is a **lightweight markup language** that allows to write **easy-to-read** and **easy-to-write** plain text format that can be converted into HTML.
...
* Includes R code that can be optionally **shown** and/or **exectuted**

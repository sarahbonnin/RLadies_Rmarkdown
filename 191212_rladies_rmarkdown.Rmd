...
subtitle: "![](https://bookdown.org/yihui/rmarkdown/images/hex-rmarkdown.png){#id .class width=30% height=30%}<br/>R-ladies BCN"
author: "Sarah Bonnin"
date: "2019-12-12"
output:
...
* Reporting
* Graphs / tables along with the code
* Reproducible
...
MISSING screenshots (how to create file + selection of title and output)
...
SCREENSHOT FROM NEW entire FILE
...
YAML header start and end with three dashes (---)
...
````r
image: ![](https://rladies.org/wp-content/uploads/2016/12/R-LadiesGlobal.png) 
````
image: ![](https://rladies.org/wp-content/uploads/2016/12/R-LadiesGlobal.png){width=50%}
